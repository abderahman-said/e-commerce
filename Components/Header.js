...
import Head_sub from "../app/head_sub";
      ...
      <div className={styles.ruby_menu_demo_header}>
        <div className={styles.ruby_wrapper}>
          <ul className={styles.ruby_menu}>
            ...
            <li className={styles.ruby_menu_mega_blog}>
              <Link href="#">كل المنتجات</Link>
            ...
            <li className={styles.ruby_menu_mega}>
              <Link href="/store">الماركات</Link>
            ...
            <li className={styles.ruby_menu_mega}>
              ...
              <div style={{ height: "510px", zIndex: "999999999999999999" }}>
                <div className={styles.ruby_row}>
                  ...
                  <div
                    className={`${styles["ruby_col_3"]} ${styles["hidden_md"]}`}
                  >
                    <h3
                      style={{
                        color: "#107eec",
            ...
            {/* __________________________________________________________ */}
            <li className={styles.ruby_menu_mega}>
              <Link href="/store">اجهزه كبيره</Link>
              <div
                style={{
                  height: "500px",
                  padding: "20px",
            ...
            {/* __________________________________________________________ */}
            <li className={styles.ruby_menu_mega}>
              <Link href="/store">اجهزه صغيره</Link>
              <div
                style={{
                  height: "500px",
                  padding: "20px",
            ...
            {/* __________________________________________________________ */}
            <li className={styles.ruby_menu_mega}>
              <Link href="/store">اجهزه المطبخ</Link>
              <div
                style={{
                  height: "500px",
                  padding: "20px",
            ...
            {/* __________________________________________________________ */}
            <li className={styles.ruby_menu_mega}>
              <Link href="/store">الكترونيات</Link>
              <div
                style={{
                  height: "500px",
                  padding: "20px",
            ...
            {/* __________________________________________________________ */}
            <li className={styles.ruby_menu_mega}>
              <Link href="/store">الصحه والجمال</Link>
              <div
                style={{
                  height: "500px",
                  padding: "20px",
